...
# Slightly modified (Exceptions handling) for python 3 capability rnaview parser
# from https://github.com/pycogent/pycogent/blob/master/cogent/parse/rnaview.py
...
def parse_filename(lines):
    ...
    """
    if len(lines) != 1:
        raise RnaViewParseError("Parse filename: expected only one line to parse")
